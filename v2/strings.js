...
const EXTRA = {
  en: {
    ...
    baseLine: 'Mont-Saint-Guibert, Belgium',
    statusLine: 'Open for Q3 2026',
    specimen: ['Portrait — 2026', 'Mono · 2409 × 1538', 'Studio light, single source'],
    coordsLabel: 'MSG · 50.63° N, 4.62° E',
  ...
  fr: {
    ...
    metaYear: 'Année',
    roleLine: 'Product Owner · Designer · Builder',
    baseLine: 'Mont-Saint-Guibert, Belgique',
    statusLine: 'Disponible Q3 2026',
    specimen: ['Portrait — 2026', 'Mono · 2409 × 1538', 'Lumière studio, source unique'],
    coordsLabel: 'MSG · 50,63° N, 4,62° E',
